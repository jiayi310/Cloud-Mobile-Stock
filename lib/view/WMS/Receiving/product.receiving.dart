...
class ReceivingProductList extends StatefulWidget {
  ReceivingProductList({
    Key? key,
  }) : super(key: key);

  @override
  State<ReceivingProductList> createState() => _ReceivingProductListState();
}

class _ReceivingProductListState extends State<ReceivingProductList> {
  List<Stock> stock = [];
  String companyid = "";
